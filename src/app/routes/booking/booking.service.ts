...
export class BookingService {
  ...
  Get_AttendanceList(AppData:string,roleId,Userid)
  {
    return this.http.get<Array<Attendance_Interface>>(environment.serverUrl + 'Attendence/FetchAttendenceByRole/' + AppData + '/' + roleId + '/' + Userid);
  }
